"""CLI entry point for ctf-autopwn."""
import logging
import sys
from pathlib import Path

from ctf_autopwn import (
    ChallengeDescriptor,
    ChallengeType,
    get_orchestrator,
    get_flag_recognizer,
...
def main():
    ...
    logger.info("CTF Autopwn Toolkit v0.1.0")
    ...
    if command == "test":
        ...
        if len(sys.argv) < 3:
            print("Usage: ctf-autopwn solve <challenge_type> [url|file]")
            return
...
def print_usage():
    ...
    print("""
CTF Autopwn - Autonomous CTF Solver

Usage:
  ctf-autopwn test              Run test/demo
  ctf-autopwn solve <type> [url|file]  Solve a challenge
